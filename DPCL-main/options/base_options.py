...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='DPCL', help='chooses which model to use.')
        ...
        # normD has no usage, we use spectral normalization for discriminator.
        ...
        parser.add_argument('--crop_size', type=int, default=256, help='then crop to this size')   # 原文512
